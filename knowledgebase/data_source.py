...
class DataSource(object):
    ...
    def fill_data_seeds(self, recreate=False):
        """
        $ python -m knowledgebase.data_source fill_data_seeds
        $ python -m knowledgebase.data_source fill_data_seeds True  # recreate tables
    ...
    def dev_stack(self):
        """
        $ python -m knowledgebase.data_source dev_stack
    ...
    def browse(self, table_name, as_json=False):
        ...
        $ python -m knowledgebase.data_source browse restaurant True
        :param table_name:
        :return:
        """
        import pandas as pd
